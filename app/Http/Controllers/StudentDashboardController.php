...
class StudentDashboardController extends Controller
{
  ...
  public function Dashboard(Request $request)
  {
    ...
    else
    {
     ...
     return view('fruntend.student.dashboard')->with(['OrgData'=>$OrgData, 'SearchData'=>$SearchData]);
  ...
  public function basic_info(Request $request)
  {
    ...
    /*dd($todaysdate);*/
     ...
     return view('fruntend.student.basic-info')->with(['OrgData'=>$OrgData, 'edData'=>$edData, 'exData'=>$exData, 'certData'=>$certData, 'indusData'=>$indusData, 'busiData'=>$busiData, 'hobbyData'=>$hobbyData, 'accomData'=>$accomData]);
