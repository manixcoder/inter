<div class="content dashboard-pg">
  <h3 class="heading"><span class="red_text"> Terms of use > </span>  Create New Line</h3>
   <div class="row">
      <div class="col-md-12 studentform textcenter">
        <form  action="{{ URL::to('add-termofuse')}}" method="POST" id="FormValidation" enctype="multipart/form-data">
        @csrf
