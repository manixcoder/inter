...
<div class="content dashboard-pg">
  <h3 class="heading"><span class="red_text"> Students</span> > Add New Student</h3>
  <div class="row">
    <div class="col-md-12 studentform textcenter">
      ...
      @endif
      <form action="{{ URL::to('add-student')}}" method="POST" id="signup-form" enctype="multipart/form-data">
        @csrf
        <div class="studentform_box">
          <div class="form_group ">
            <div class="upload_btn">
              <div class="upload_box">
                <input type="file" class="form_control" onchange="loadFile(event)" name="image">
              </div>

              <div class="upload_text">
                <img src="{{ asset('public/assets/images/upload_img.svg')}}" id="output" alt="upload_img">
                <span class="uplod_text">Profile Photo</span>
              </div>
            </div>
          </div>

          <div class="form_group">
            <input type="text" name="name" id="name" placeholder="Student Name" class="form_control" value="{{ $name ?? ''}}" required="" maxlength="100">
          ...
          <div class="form_group">
            <input type="text" name="phone" id="valphon" placeholder="Mobile Number" class="form_control" value="{{ $phone ?? ''}}" required="" maxlength="10" onkeyup="this.value=this.value.replace(/[^\d]/,'') ">
            <span style="display:none; color: red;" class="vali_phon">Please enter Mobile number.</span>
          </div>

          <!-- <div class="form_group">
                        <input type="password" id="password" name="password" placeholder="Create Password" class="form_control" value="{{ $password ?? ''}}" required="" minlength="8" onKeyUp="checkPasswordStrength();">
