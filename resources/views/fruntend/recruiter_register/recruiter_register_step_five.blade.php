      ...
      <div class="login_wapper">
        <div class="login_contbox digitcode_sec reset_password">
          <div class="logo_img fw">
           ...
           <form class="welcome_cont regsteptow-sec fw" action="{{ url('recruider_register_step_one') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="innerrow">
              <div class="col_grid12 digitcode">
                <h5>5 <i><img src="{{ asset('public/assets/images/logininput_right.png') }}" alt="icon"></i> Perfect! What’s your organization’s name?</h5>
              </div>
            </div>
            <div class="from-group fw">
              ...
              <input type="text" name="org_name" class="form-control" placeholder="Enter organization name" required="" maxlength="100" />
            </div>
