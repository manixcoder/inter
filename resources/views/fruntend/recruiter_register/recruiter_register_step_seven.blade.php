    ...
    <div class="loginBGRED_sec forgot_pass_pg">
      <div class="login_wapper" >
        <div class="login_contbox digitcode_sec reset_password">
          ...
          <form class="welcome_cont regstepfive-sec fw" action="{{ url('recruider_register_step_one') }}" method="POST" enctype="multipart/form-data" id="signup-form">
            @csrf
            <div class="innerrow">
            ...
            <div class="from-group fw">
              ...
              <input type="password" id="password_reg" name="password" class="form-control" maxlength="50" required placeholder="Enter your password"> 
              <span class="glyphicon form-control-feedback" id="password_reg1">
            </div>

            <div class="from-group fw">              
              <input type="password" name="confirmPassword" id="confirmPassword" class="form-control" disabled required autocomplete="off" maxlength="50" placeholder="Re-enter your password" />
