        ...
        <form class="welcome_cont fw" action="{{ url('student_register_step_one') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="innerrow">
            <div class="col_grid12 digitcode">
              <h5>
                ...
                Awesome! What’s your company’s official email address?
              </h5>
            </div>
          </div>
          ...
          <div class="text-right fw continue_topbtn">
            ...
            <span class="pull-right btn_continue">
              <button type="submit" id='btnValidate' class="input-btn">
                Continue
                <span>
                  <img src="{{ asset('public/assets/images/logini  nput_right.png')}}" class="wht-icon" alt="icon">
                </span>
                <span>
