          ...
          <div class="logo_img fw">
           ...
           <form class="welcome_cont fw" action="{{ url('student_register_step_one') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="from-group fw">
              ...
              <input type="text" name="email" id='txtEmail' placeholder="Enter your email designation" class="email form-control" required>
            ...
            <div class="text-right fw continue_topbtn">
              ...
              <span class="pull-right btn_continue">
                <button type="submit" id='btnValidate' class="input-btn">Continue <span><img src="{{ asset('public/assets/images/logini  nput_right.png')}}" class="wht-icon" alt="icon"></span><span><img src="{{ asset('public/assets/images/arrow_right_red.png')}}" class="none-img redimg-arrow" alt="icon" ></span></button>
              </span>
            </div>
          </div>
        </div>
