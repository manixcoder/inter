          ...
          <div class="innerrow">
            <div class="col_grid12">
              ...
              <div class="jobsDetailComp_cont">
                ...
                <h3><a href="#" class="lightblue_text clrBlack">{{ $Data->job_title ?? ''}}</a></h3>
                <p>{{ $Data->location ?? ''}}</p>
              </div>
            </div>
            <div class="col_grid3" style="display: none;">
              <div class="retextbtn_sec">
                <a href="./compnay_profile.html" class="retextbtn">View Company Profile <span><img src="images/arrow_right_red.png" alt="redarrow" /></span></a>
              </div>                                      
                      ...
                      <div class="innerrow">
                        ...
                        <div class="col_grid12 intercandidatesProfile">
                          <div class="innerrow">
                            <div class="col_grid9">
                              <div class="cvpdf">
                                <a href="#"><img src="{{ URL::asset('/public/assets/images/fileupload_sec.png') }}" alt="icon">{{ $value->resume ?? ''}}<img src="{{ URL::asset('/public/assets/images/download.png') }}" alt="icon"></a>
                              </div>
                              <div class="retextbtn_sec">
                                <a href="{{ URL::to('company-details',$Data->id) }}" class="retextbtn">View Profile <span><img src="{{ URL::asset('/public/assets/images/arrow_right_red.png') }}" alt="redarrow"></span></a>
                              </div>
                            </div>
