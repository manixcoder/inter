        ...
        <form action="{{ url('student_logged_in') }}" method="POST" enctype="multipart/form-data" class="welcome_cont fw">
          ...
          <div class="innerrow">
            ...
            <div class="text-right col_grid4">
              <button type="submit" class="input-btn">Login <span><img src="{{ asset('public/assets/images/logini  nput_right.png')}}" class="wht-icon" alt="icon"></span><span><img src="{{ asset('public/assets/images/arrow_right_red.png')}}" class="none-img redimg-arrow" alt="icon"></span></button>
            </div>
          </div>
