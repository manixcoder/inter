<div class="innerrow">
          <div class="col_grid3">
            <a href="./recruiter_homepage.html" class="logo-flow2">
          ...
          <div class="col_grid9 text-right">
            <div class="header_menu fw">
              ...
              <ul class="menu_right">
                <li>
                  <a href="./recruiter_homepage.html">Home </a>
                </li>
                <li>
                  <a href="./blogsrecuiter.html">Blogs </a>
                </li>
                <li>
                  <a href="{{URL::to('web/post/jobs')}}">Post a Job </a>
                </li>
                <li>
                  <a href="./notifications_recuiter.html">Notifications </a>
                </li>
                <li>
                  <a href="./contact_us-recuiter.html">Contact Us </a>
                </li>
              </ul>
              <div class="login_user">
                ...
                <ul class="userdrop_down">
                  ...
                  <li>
                    <a href="./setting-recuiter.html">Settings</a>
                  </li>
                  <li>
                    <a href="./change_passwordrecuiter.html">Change Password</a>
                  </li>
                  <li>
