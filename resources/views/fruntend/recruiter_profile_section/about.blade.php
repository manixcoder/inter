    ...
    <div class="innerrow">
      <div class="col_grid12 ">
        <div class="form-group">
          ...
          <textarea name="requirter_overview" id="requirter_overview" cols="100" rows="200" class="form-control">{{ $recruiterInfo->requirter_overview }}</textarea>
      ...
      <div class="col_grid12 ">
        <div class="form-group">
          <label>Website</label>
          <input type="text" name="website" id="website" placeholder="" class="form-control" value="{{ $recruiterInfo->website ?? ''}}">
      ...
      <div class="col_grid6 ">
        <div class="form-group">
          ...
          <input type="text" name="industry" id="industry" placeholder="" class="form-control" value="{{ $recruiterInfo->industry ?? ''}}">
      ...
      <div class="col_grid6 ">
        <div class="form-group">
          ...
          <input type="text" name="company_size" id="company_size" placeholder="" class="form-control" value="{{ $recruiterInfo->company_size ?? ''}}">
      ...
      <div class="col_grid12 ">
        <div class="form-group">
          ...
          <input type="text" name="org_name" id="org_name" placeholder="" class="form-control" value="{{ $recruiterInfo->org_name ?? ''}}">
      ...
      <div class="col_grid12 ">
        <div class="form-group">
          ...
          <input type="text" name="headquarters" id="headquarters" placeholder="" class="form-control" value="{{ $recruiterInfo->headquarters ?? ''}}">
      ...
      <div class="col_grid6 ">
        <div class="form-group">
          <label>Founded</label>
          <input type="text" name="founded" id="founded" placeholder="" class="form-control" value="{{ $recruiterInfo->founded ?? ''}}">
      ...
      <div class="col_grid12 ">
        <div class="form-group">
          ...
          <textarea name="specialties" id="specialties" cols="30" rows="10" class="form-control">{{ $recruiterInfo->specialties ?? '' }}</textarea>
      ...
      <!-- <button type="submit" class="input-btn text-left" id="btnValidate2"> -->
        <button type="submit" class="input-btn text-left" id="btnValidate2">
          Edit About
          <i>
