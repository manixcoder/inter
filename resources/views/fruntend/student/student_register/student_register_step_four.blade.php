        ...
        <form class="welcome_cont fw" action="{{ url('student_register_step_one') }}" method="POST" enctype="multipart/form-data" id="signup-form">
          ...
          <div class="innerrow">
            <div class="col_grid12 digitcode">
              <h5>4 <i><img src="{{ asset('public/assets/images/logininput_right.png')}}" alt="icon"></i> Amazing! Now, create your password. </h5>
            </div>
          </div>
          <div class="from-group fw">
            ...
            <input type="password" id="password_reg" name="password" class="form-control" required placeholder="Enter your password">
            <span class="glyphicon form-control-feedback" id="password_reg1">
          </div>

          <div class="from-group fw">
            <input type="password" name="confirmPassword" id="confirmPassword" class="form-control" disabled required autocomplete="off" placeholder="Re-enter your password" />
