  ...
  <div class="loginBGRED_sec forgot_pass_pg">
    <div class="login_wapper">
      <div class="login_contbox digitcode_sec reset_password">
        ...
        <form class="welcome_cont regstepone-sec fw" action="{{ url('student_register_step_one') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="innerrow">
          ...
          <div class="from-group fw">
            ...
            <input type="text" name="name" class="form-control" placeholder="Enter your full name" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" required="" />
          </div>
