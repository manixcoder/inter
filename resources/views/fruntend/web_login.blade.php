          ...
          <form  action="{{ URL::to('web-login-dashboard') }}" method="POST" class="welcome_cont fw"  id="signup-form" enctype="multipart/form-data">
            ...
            <div class="innerrow">
              ...
              <div class="text-right col_grid4">
                <button type="submit" id="btnValidate" class="input-btn">Login <span><img src="{{ asset('public/assets/images/logininput_right.png')}}" class="wht-icon" alt="icon"></span><span><img src="{{ asset('public/assets/images/arrow_right_red.png')}}" class="none-img redimg-arrow" alt="icon" ></span></button>
              </div>
            </div>
