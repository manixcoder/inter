        ...
        <div class="content-group fw">
          <div class="text-cont fw">
            ...
            <div class="admin-date-box fw">
              <span class="gary-small-text text-left col_grid6">Posted on :<span>{{date('d M Y | H:i'  , strtotime($Data->posted_date_and_time))}}</span></span>
          ...
          <div class="img-cont fw">
            <figure class="full-img">
              <img src="{{ URL::asset('/public/assets/blogs_images/') }}/{{ $Data->blog_image }}" alt="img1" />
            </figure>
          </div>
          <div class="viewdetail_pra fw">
            <p class="site-pra"> {{ $Data->description ?? ''}}</p>
          </div>
        </div>
      </div>
                        ...
                        <div class="col_grid6">
                            <div class="content-group fw">
                              <div class="text-cont fw">
                                ...
                                <div class="viewdetail_pra fw">
                                  <p class="site-pra">
                                    {{ $value->description ?? ''}} <!--.…. <a href="#" class="read_more_btn">READ MORE</a>-->
                                  </p>
                                </div>
                                <div class="img-cont fw">
                                  <figure class="full-img">
                                ...
                                <div class="admin-date-box fw">
                                  <span class="gary-small-text text-left col_grid6">Posted on :<span>{{date('d M Y | H:i'  , strtotime($value->posted_date_and_time))}}</span></span>
                                  <span class="gary-small-text text-right col_grid6">Posted by :<span>{{ $createdby->name ?? ''}}</span></span>
                                </div>
                              </div>
                            </div>
